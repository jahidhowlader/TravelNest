...
const Reservation = () => {
    ...
    return (
        ...
        <>
            <section className="my-container my-20 lg:my-28 min-h-scree">
                {
                    !location.state?.options ?
                        <div className="flex flex-col justify-center items-center ">
                            <h1 className="text-3xl lg:text-6xl primary-font font-bold">
                                Booking Checkout
                            </h1>
                            <h3 className="text-xl lg:text-3xl text-center primary-font font-semibold pt-5 lg:pb-20">You had a mistake, Please go to your back space!</h3>
                        </div> : (
                            <>
                                <div>
                                    ...
                                    <div className="grid lg:grid-cols-12 w-full">
                                        <div className="lg:col-span-8 lg:pr-20 w-full">
                                            <h2 className="text-2xl lg:text-4xl primary-font font-bold">Billing Details</h2>

                                            <div className="border flex items-center gap-3 rounded-sm p-2 lg:p-4 my-8">
                                                <GoGift className="text-primary-color text-xl" />
                                                <p className="lg:text-lg font-medium">Your promotion code <span className="text-primary-color">HNY24</span></p>
                                            </div>
                                            ...
                                            <div className='space-y-8'>
                                                ...
                                                <h4 className="text-2xl lg:text-3xl primary-font font-bold ">Choose Additional Services</h4>
                                        ...
                                        <aside className="lg:col-span-4 w-full">
                                            <div className="lg:sticky w-full top-10 border border-gray border-opacity-[0.15] rounded-md bg-white shadow-sm p-7">

                                                <h2 className="text-2xl lg:text-4xl primary-font font-bold">Your Stay</h2>

                                                {/* Checkin */}
                                                <div className="flex items-center gap-16 mt-5">
                                                    <div>
                                                        <p className='opacity-50 pb-1 font-medium text-xs sm:text-sm'>CHECK IN</p>
                                                        <p className='font-medium'>{`${format(date[0].startDate, "dd/MM/yyyy")}`}</p>
                                                    </div>

                                                    <div>
                                                        <p className='opacity-50 pb-1 font-medium text-xs sm:text-sm'>CHECK OUT</p>
                                                ...
                                                <div className="flex justify-between items-center border border-gray border-opacity-[0.15] border-l-0 border-r-0 my-2 py-3">
                                                    <span className='opacity-50 text-xs sm:text-sm font-medium'>GUEST</span>
                                                ...
                                                <div className="border-b border-gray border-opacity-[0.15] my-2 py-3">
                                                    <span className='opacity-50 text-xs sm:text-sm font-medium'>ROOMS</span>
                                                ...
                                                <div className="flex justify-between border-b border-gray border-opacity-[0.15] my-2 py-3">
                                                    <div>
                                                        ...
                                                        <span className={`${pickUp ? 'block text-xs sm:text-base' : 'hidden'}`}>Airport Pick-up <span className="text-primary-color font-medium">$12</span><br /></span>
                                                        <span className={`${laundry ? 'block text-xs sm:text-base' : 'hidden'}`}>Laundry Service <span className="text-primary-color font-medium">${additionalPrice.totalLaundry}</span></span>
                                                ...
                                                <div className="flex justify-between items-center  mt-4 ">
                                                    <span className='font-medium sm:text-lg'>SUBTOTAL PRICE</span>
                                                    <span className="font-medium sm:text-lg text-primary-color">${totalPrice}</span>
                                                </div>
                                            </div>
                                        </aside>
                                    </div>
