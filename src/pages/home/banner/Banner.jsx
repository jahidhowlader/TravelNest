    ...
    return (
        <section className="bg-black pb-10 md:pb-12 lg:pb-20 text-white relative">
            <div className="ml-5 mr-10 sm:mx-10 md:mx-28 lg:mx-48 grid grid-cols-12 items-center relative">
                ...
                >
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-7xl 3xl:text-8xl primary-font font-bold">The <span className="italic">Botique Design</span> <br />Apartments</h1>
                    <p className="text-xs sm:text-base lg:text-lg my-5 xl:my-12 2xl:my-16">From $64 per person and night</p>
                    <button className="bg-primary-color px-3 py-1 sm:px-6 2xl:px-10 sm:py-2 2x:py-3 font-medium uppercase text-xs sm:text-sm xl:text-base">explorer rooms</button>
                </motion.div>
            ...
            <motion.div
                className="absolute right-3 md:right-12 lg:right-20 top-0 my-5 md:my-10 2xl:my-16 h-full"
